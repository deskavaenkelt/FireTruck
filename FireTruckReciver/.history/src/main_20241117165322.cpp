...
// Pulse timing variables for steering
...
void blinkBlueLeds() {
    // Blink individually but dont halt the program with delay, use millis() with 500ms intervals
}

void blinkWhiteLeds() {
    // Blink individually but dont halt the program with delay, use millis() with 250ms intervals
}